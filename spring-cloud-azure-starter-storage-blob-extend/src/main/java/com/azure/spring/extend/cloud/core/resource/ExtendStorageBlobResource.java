...
public class ExtendStorageBlobResource extends ExtendAzureStorageResource {
     ...
     */
    public ExtendStorageBlobResource(BlobServiceClient blobServiceClient, String location) {
     ...
     */
    public ExtendStorageBlobResource(BlobServiceClient blobServiceClient, String location, Boolean autoCreateFiles) {
